                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card job-detail overflow-hidden">
                            <div>
                                <img src="{{ asset('assets/site/images/job-detail.jpg') }}" alt="" class="img-fluid">
                                <div class="job-details-compnay-profile">
                                    <img src="{{ asset('assets/site/images/featured-job/img-10.png') }}" alt="" class="img-fluid rounded-3 rounded-3">
                                </div>
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="job-box card mt-4">
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-lg-1">
                                            <img src="{{ asset('assets/site/images/featured-job/img-01.png') }}" alt="" class="img-fluid rounded-3">
                                        </div><!--end col-->
                                        <div class="col-lg-10">
                            ...
                            <div class="job-box bookmark-post card mt-4">
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-lg-1">
                                            <img src="{{ asset('assets/site/images/featured-job/img-02.png') }}" alt="" class="img-fluid rounded-3">
                                        </div><!--end col-->
                                        <div class="col-lg-10">
                                            <div class="mt-3 mt-lg-0">
                            ...
                            <div class="job-box card mt-4">
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-lg-1">
                                            <img src="{{ asset('assets/site/images/featured-job/img-03.png') }}" alt="" class="img-fluid rounded-3">
                                        </div><!--end col-->
                                        <div class="col-lg-10">
                                            <div class="mt-3 mt-lg-0">
                        ...
                        <div class="side-bar ms-lg-4">
                            ...
                            <div class="card company-profile mt-4">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mt-4">
                                        <a href="company-details.html" class="btn btn-primary btn-hover w-100 rounded"><i class="mdi mdi-eye"></i> View Profile</a>
                                    </div>
                                </div>
                            </div>
